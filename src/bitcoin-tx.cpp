...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cricy Core cricy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cricy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cricy transaction") + "\n" +
              "  cricy-tx [options] -create [commands]   " + _("Create hex-encoded cricy transaction") + "\n" +
              "\n";
